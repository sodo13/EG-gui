...
class AdapterSetup(Screen, ConfigListScreen, HelpableScreen):
    ...
    def createSetup(self):
        ...
        if self.activateInterfaceEntry.value:
            ...
            havewol = False
            if SystemInfo['WakeOnLAN'] and getBoxType() not in ('et10000', 'gb800seplus', 'gb800ueplus', 'gbultrase', 'gbultraue', 'gbipbox', 'gbquad'):
                havewol = True
...
class AdapterSetupConfiguration(Screen, HelpableScreen):
    ...
    def __init__(self, session, iface):
        ...
        self['OkCancelActions'] = HelpableActionMap(self, 'OkCancelActions', {'cancel': (self.close, _('exit networkadapter setup menu')),
