...
class ScanSetup(ConfigListScreen, Screen, CableTransponderSearchSupport):
    ...
    def newConfig(self):
        ...
        print 'cur is', cur
        if cur == self.typeOfScanEntry or cur == self.typeOfInputEntry or cur == self.tunerEntry or cur == self.systemEntry or cur == self.preDefSatList or cur == self.TerrestrialRegionEntry or self.modulationEntry and self.systemEntry[1].value == eDVBFrontendParametersSatellite.System_DVB_S2 and cur == self.modulationEntry:
            self.createSetup()
    ...
    def createConfig(self, frontendData):
        ...
        self.scan_sat.fec_s2 = ConfigSelection(default=defaultSat['fec_s2'], choices=[(eDVBFrontendParametersSatellite.FEC_1_2, '1/2'),
         (eDVBFrontendParametersSatellite.FEC_2_3, '2/3'),
         (eDVBFrontendParametersSatellite.FEC_3_4, '3/4'),
