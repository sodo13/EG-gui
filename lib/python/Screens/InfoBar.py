...
class InfoBar(, InfoBarServiceErrorPopupSupport, InfoBarJobman, InfoBarZoom, InfoBarHdmi, InfoBarButtonSetup, Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = HelpableActionMap(self, 'InfobarActions', {'showMovies': (self.showMovies, _('Play recorded movies...')),
         ...
         'showFormat': (self.showFormat, _('Show Format Setup...'))}, prio=2)
        self.radioTV = 0
        self.allowPiP = True
