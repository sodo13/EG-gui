...
class InfoBarTimeshift:
    ...
    def __init__(self):
        ...
        self['TimeshiftFileActions'] = ActionMap(['InfobarTimeshiftActions'], {'jumpPreviousFile': self.__evSOF,
    ...
    def ptsCleanTimeshiftFolder(self, justZapped = True):
        ...
        if filecounter == 0:
            self.ptsEventCleanTimerSTOP()
        elif self.checkEvents_value != int(config.timeshift.timeshiftCheckEvents.value):
            if self.pts_cleanEvent_timer.isActive():
