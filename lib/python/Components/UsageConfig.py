...
def InitUsageConfig():
    ...
    config.usage.second_infobar_style = ConfigSelection(default='thirdinfobar', choices=[('thirdinfobar', _('New style')), ('secondinfobar', _('Old style'))])
