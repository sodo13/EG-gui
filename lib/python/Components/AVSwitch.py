...
class AVSwitch():
    ...
    if about.getChipSetString() in ('7241', '7358', '7362', '7346', '7356', '7424', '7425', '7435', 'pnx8493') or hw_type in ('elite', 'premium', 'premium+', 'ultra', 'me', 'minime'):
        modes['HDMI'] = ['720p',
         '1080p',
         '1080i',
         '576p',
    ...
    if modes.has_key('YPbPr') and getBoxType() in ('enibox', 'mutant1100', 'et4x00', 'et7500', 'et7000', 'et8500', 'xp1000mk', 'xp1000max', 'xp1000plus', 'sf8', 'tm2t', 'tmsingle', 'vusolo2', 'tmnano', 'iqonios300hd', 'classm', 'axodin', 'axodinc', 'genius', 'evo', 'galaxym6', 'geniuse3hd', 'evoe3hd', 'axase3', 'axase3c', 'dm500hdv2', 'dm500hd', 'dm800', 'mixosf7', 'mixoslumi', 'mixosf5mini', 'gi9196lite', 'ixusszero', 'optimussos1', 'enfinity', 'marvel1', 'sezam1000hd', 'mbmini', 'atemio5x00', 'xpeedlx1', 'xpeedlx2', 'vusolose', 'gbipbox', 'formuler3', 'optimussos3plus', 'force1plus') or about.getModelString() == 'ini-3000':
        del modes['YPbPr']
    if modes.has_key('Scart') and getBoxType() in ('tmnano', 'tmnano3t', 'tmnano2super', 'formuler3', 'enibox', 'mbminiplus', 'mbhybrid'):
...
def InitAVSwitch():
    ...
    config.av.smart1080p = ConfigSelection(choices={'false': _('off'),
     ...
     '720p50': _('720p50: 24/50/60Hz')}, default='false')
