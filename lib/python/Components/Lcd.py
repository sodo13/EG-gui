...
def InitLcd():
    if getBoxType() in ('gb800se', 'gb800solo', 'gb800seplus', 'gbipbox', 'tmsingle', 'tmnano2super', 'iqonios300hd', 'optimussos1plus', 'optimussos1', 'vusolo', 'et4x00', 'et5x00', 'et6x00', 'et7000', 'mixosf7', 'mixoslumi'):
        detected = False
    else:
